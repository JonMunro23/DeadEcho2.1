        ...
        private void Update()
        {
            ...
            if (m_UIController.InventoryManager.Target)
            {
                ...
                if (gunPickup)
                {
                    ...
                    {
                        m_InteractActionText.text = "PURCHASE " + gunPickup.weaponName + "<br>$" + gunPickup.WeaponCost;
                        ShowInteractAction();
                    }
                    else
                    {
                        m_InteractActionText.text = "PURCHASE AMMO <br>$" + 500;
                        ShowInteractAction();
                    }
                }
                ...
                bool isDoor = m_UIController.InventoryManager.Target.CompareTag(m_UIController.InventoryManager.DoorTag);
