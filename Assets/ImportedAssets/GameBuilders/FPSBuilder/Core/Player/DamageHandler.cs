...
namespace GameBuilders.FPSBuilder.Core.Player
{
    ...
    public class DamageHandler : MonoBehaviour, IProjectileDamageable, IExplosionDamageable, IStunnable
    {
        ...
        {
            PlayerUpgrades.onUpgradesRefreshed += UpdateTotalVitality;
        }
        ...
        private void UpdateTotalVitality()
        {
            m_Vitality = baseMaxVitality;
            m_Vitality += baseMaxVitality * PlayerUpgrades.maxHealthModifier;
        }
