...
namespace GameBuilders.FPSBuilder.Core.Equipment
{
    ...
    public sealed class FirstAidKit : Equipment
    {
        ...
        private IEnumerator AdrenalineShot()
        {
            ...
            m_HealthController.Heal(m_HealAmount + m_HealAmount * PlayerUpgrades.healthRecoverModifier, m_HealInjuries, m_StaminaBonus && m_StaminaBonusDuration > 0, m_StaminaBonusDuration);
            if (!m_InfiniteShots)
                m_Amount--;
        ...
        /// </summary>
        public override void RefillAll()
        {
            m_Amount = m_MaxAmount;
        }

        /// <summary>
        /// Refill a certain amount of adrenaline syringes.
        /// </summary>
        /// <param name="amountToRefil">The amount of syringes to refill</param>
        public override void RefillAmount(int amountToRefil)
        {
            m_Amount += amountToRefil;
