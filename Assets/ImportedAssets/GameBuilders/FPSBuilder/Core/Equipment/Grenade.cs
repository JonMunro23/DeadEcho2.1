...
namespace GameBuilders.FPSBuilder.Core.Equipment
{
    ...
    public sealed class Grenade : Equipment
    {
        ...
        {
            m_Amount = m_MaxAmount + PlayerUpgrades.grenadeCarryAmountModifier;
        }

        /// <summary>
        /// Refill a certain amount of grenades.
        /// </summary>
        /// <param name="amountToRefil">The amount of grenades to refill</param>
        public override void RefillAmount(int amountToRefil)
        {
            m_Amount += amountToRefil;
            if(m_Amount > m_MaxAmount + PlayerUpgrades.grenadeCarryAmountModifier)
                m_Amount = m_MaxAmount + PlayerUpgrades.grenadeCarryAmountModifier;
        }
    }
}
