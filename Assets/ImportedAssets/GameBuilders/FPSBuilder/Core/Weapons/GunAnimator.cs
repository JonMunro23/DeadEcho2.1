...
namespace GameBuilders.FPSBuilder.Core.Weapons
{
    ...
    public sealed class GunAnimator : IWeaponAnimator
    {
        ...
        /// <summary>
        /// Standing Position is the default position of the weapon.
        /// </summary>
        [SerializeField]
        ...
        /// <summary>
        /// Crouch Position will define the weapon position when the current state of the character is Crouch.
        /// </summary>
        [SerializeField]
        ...
        internal void Reload(bool roundInChamber)
        {
            ...
            if (!roundInChamber)
            {
                ...
                m_Animator.SetFloat(m_SpeedParameterHash, m_ReloadEmptySpeed + (m_ReloadEmptySpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

                m_Animator.CrossFadeInFixedTime(m_ReloadEmptyAnimation, 0.1f);
                
                if (m_ReloadEmptySound)
                    m_PlayerWeaponGenericSource.ForcePlay(m_ReloadEmptySound, m_ReloadVolume, PlayerUpgrades.reloadSpeedModifier);
            }
            else
            {
                ...
                m_Animator.SetFloat(m_SpeedParameterHash, m_ReloadSpeed + (m_ReloadSpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

                m_Animator.CrossFadeInFixedTime(m_ReloadAnimation, 0.1f);
                
                if (m_ReloadSound)
                    m_PlayerWeaponGenericSource.ForcePlay(m_ReloadSound, m_ReloadVolume, PlayerUpgrades.reloadSpeedModifier);
            }
        }
        ...
        internal void StartReload(bool roundInChamber)
        {
            ...
            if (!roundInChamber)
            {
                ...
                m_Animator.SetFloat(m_SpeedParameterHash, m_InsertInChamberSpeed + (m_InsertInChamberSpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

                m_Animator.CrossFadeInFixedTime(m_InsertInChamberAnimation, 0.1f);
                m_PlayerWeaponSource.Stop();
                
                if (m_InsertInChamberSound)
                    m_PlayerWeaponGenericSource.ForcePlay(m_InsertInChamberSound, m_InsertInChamberVolume, PlayerUpgrades.reloadSpeedModifier);
            }
            else
            {
                ...
                m_Animator.SetFloat(m_SpeedParameterHash, m_StartReloadSpeed + (m_StartReloadSpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

                m_Animator.CrossFadeInFixedTime(m_StartReloadAnimation, 0.1f);
                m_PlayerWeaponSource.Stop();
                
                if (m_StartReloadSound)
                    m_PlayerWeaponGenericSource.ForcePlay(m_StartReloadSound, m_StartReloadVolume, PlayerUpgrades.reloadSpeedModifier);
            }
        }
        ...
        internal void Insert()
        {
            ...
            m_Animator.SetFloat(m_SpeedParameterHash, m_InsertSpeed + (m_InsertSpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

            m_Animator.CrossFadeInFixedTime(m_InsertAnimation, 0.1f);
            
            if (m_InsertSound)
                m_PlayerWeaponGenericSource.ForcePlay(m_InsertSound, m_InsertVolume, PlayerUpgrades.reloadSpeedModifier);
        }
        ...
        internal void StopReload()
        {
            ...
            m_Animator.SetFloat(m_SpeedParameterHash, m_StopReloadSpeed + (m_StopReloadSpeed * PlayerUpgrades.reloadSpeedModifier) + 0.1f);

            m_Animator.CrossFadeInFixedTime(m_StopReloadAnimation, 0.1f);
            
            if (m_StopReloadSound)
                m_PlayerWeaponGenericSource.ForcePlay(m_StopReloadSound, m_StopReloadVolume, PlayerUpgrades.reloadSpeedModifier);
        }
