...
namespace GameBuilders.FPSBuilder.Core.Weapons
{
    ...
    public sealed class GunData : ScriptableObject
    {
        ...
        /// <summary>
        /// The cost of the weapon when buying from the wall.
        /// </summary>
        [SerializeField]
        [MinMax(0, Mathf.Infinity)]
        [Tooltip("The cost of the weapon when buying from the wall.")]
        private int m_WeaponCost = 0;
        ...
        /// <summary>
        /// Defines how fast this gun will be inaccurate due to constant shooting.
        /// </summary>
        [SerializeField]
        [Range(0, 3)]
        [Tooltip("Defines how fast this gun will be inaccurate due to constant shooting.")]
        private float m_DecreaseRateByShooting = 1;

        /// <summary>
        /// Defines how fast this gun will be inaccurate due to constant shooting whilst aiming.
        /// </summary>
        [SerializeField]
        [Range(0, 3)]
        [Tooltip("Defines how fast this gun will be inaccurate due to constant shooting whilst aiming.")]
        private float m_DecreaseRateByShootingWhileAiming = 1;
        ...
        /// <summary>
        /// The cost of the weapon. (Read Only)
        /// </summary>
        public int WeaponCost => m_WeaponCost;
        ...
        /// <summary>
        /// Defines how fast this gun will be inaccurate due to the character movement. (Read Only)
        /// </summary>
        public float DecreaseRateByWalking => m_DecreaseRateByWalking;

        /// <summary>
        /// Defines how fast this gun will be inaccurate due to constant shooting. (Read Only)
        /// </summary>
        public float DecreaseRateByShooting => m_DecreaseRateByShooting;

        /// <summary>
        /// Defines how fast this gun will be inaccurate due to constant shooting whilst aiming. (Read Only)
        /// </summary>
        public float DecreaseRateByShootingWhileAiming => m_DecreaseRateByShootingWhileAiming;
        ...
        public float CalculateDamage(float distance)
        {
            switch (DamageType)
            {
                case AmmoType.DamageMode.Constant:
                    return Damage + Damage * PlayerUpgrades.weaponDamageModifier; ;
                case AmmoType.DamageMode.DecreaseByDistance:
                    return (Damage * DamageFalloffCurve.Evaluate(distance / Range)) + Damage * PlayerUpgrades.weaponDamageModifier; ;
                default:
                    return Damage + Damage * PlayerUpgrades.weaponDamageModifier;
            }
        }
