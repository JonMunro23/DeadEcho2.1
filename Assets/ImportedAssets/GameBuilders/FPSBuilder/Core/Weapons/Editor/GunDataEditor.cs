...
namespace GameBuilders.FPSBuilder.Core.Weapons.Editor
{
    ...
    public sealed class GunDataEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty m_WeaponCost;
        ...
        private SerializedProperty m_DecreaseRateByShootingWhileAiming;
        ...
        private void OnEnable ()
        {
            ...
            m_WeaponCost = serializedObject.FindProperty("m_WeaponCost");
            ...
            m_DecreaseRateByShootingWhileAiming = serializedObject.FindProperty("m_DecreaseRateByShootingWhileAiming");
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (m_GunName.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_WeaponCost, new GUIContent("Weapon Cost ($)"));
            ...
            if (m_HIPAccuracy.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_DecreaseRateByShootingWhileAiming);
